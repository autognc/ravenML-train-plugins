...
class MyTrainableEstimator(Trainable):
    ...
    ### HELPERS ###
    def _get_paths_for_extra_files(self):
        ...
        # path to label map
        labels_path = self.base_dir / 'data' / 'label_map.pbtxt'
    ...
    def _export_frozen_inference_graph(self, pipeline_config_path, checkpoint_path, output_directory):
