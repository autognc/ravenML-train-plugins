...
tensorflow_pkg ='tensorflow-gpu==1.14.0'

setup(
    name='rmltraintunetfbbox',
    version='0.3',
    description='Tensorflow Bounding Box training plugin for ravenml with tune for hyperparmeter optimization',
    ...
    entry_points='''
        ...
        tf_bbox_tune=rmltraintunetfbbox.core:tf_bbox_tune
    '''
)
