...
#
# Install/uninstall script for raven TensorFlow Instance Segmentation plugin.
##
...
if [ $install -eq 1 ]; then
    ...
    echo "Uninstalling..."
    pip uninstall ravenml-tf-instance -y
fi
